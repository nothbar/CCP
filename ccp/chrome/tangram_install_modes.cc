...
// Brand-specific constants and install modes for Tangram.

#include "tangram_install_modes.h"
...
const wchar_t kProductPathName[] = L"Tangram";
...
const wchar_t kBinariesPathName[] = L"Tangram Binaries";

const char kSafeBrowsingName[] = "tangram";
