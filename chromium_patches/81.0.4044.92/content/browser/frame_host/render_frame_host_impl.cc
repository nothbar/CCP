...
void RenderFrameHostImpl::DocumentOnLoadCompleted() {
  ...
  if (g_pTangramImpl) {
	  ...
	  TangramCommon::CChromeRenderFrameHost* pHost = static_cast<TangramCommon::CChromeRenderFrameHost*>(this);
...
void RenderFrameHostImpl::OnTangramMessage(std::wstring id,
    std::wstring param1,
    std::wstring param2,
    std::wstring param3,
    std::wstring param4,
    ...
    if (g_pTangramImpl)
    {
        g_pTangramImpl->m_pCurrentIPCMsg = nullptr;
    }
}

void RenderFrameHostImpl::OnTangramMessage2(std::wstring id,
    std::wstring param1,
    long handle,
    long nID,
    std::wstring param4,
