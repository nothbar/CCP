...
__declspec(dllexport) int __stdcall InitApp(bool bSupportCrashReporting) {
  ...
  typedef TangramCommon::CTangramMainDllLoader*(__stdcall * SetMainDllLoader)(TangramCommon::CTangramMainDllLoader * pLoader);
  ...
  if (pSetMainDllLoader != NULL) {
    pSetMainDllLoader((TangramCommon::CTangramMainDllLoader*)MakeMainDllLoader());
  }
  return 0;
}
